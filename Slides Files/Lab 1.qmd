...
This plot gives a good graphical representation of the variance of a variable (I will use it again later to show something!). However, for visualizing data, we have better options...

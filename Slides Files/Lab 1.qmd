---
title: "Lab 1: Descriptive Staistics and Plots"
author: "Fabio Setti"
...
format:
   revealjs:
      footer: "Lab 1: Descriptive Staistics and Plots"
      width: 1280
      height: 720
      chalkboard: true
      slide-number: c/t 
...
We use one of the `geom_...()` function do add shapes to our plot.
...
This plot may help to get a sense of the range of a variable, but there's probably better plots...
...
<li> **y-axis:** Values corresponding to the corresponding observed quantiles of our variable </li>
...
If the explanation before made no sense, here's a recreated QQplots to convince you
...
<div style="font-size: 22px"> As mentioned, the quantiles generated from any different normal distribution will not change the pattern of the dots (magic? Do give this some thought if it does not make sense to you) </div>

...
<div style="font-size: 22px; padding-top: 16px;"> Also note that the spline regression line is smooth. This is because by default the `slpine` package uses 3<sup>rd</sup> degree polynomial segments. (see `help(bsp)`) </div>

...
<li>  $e = 0.61$, the expected spread around the regression line, AKA the **residual variance**\* </li>

</ul>

<div style="font-size: 22px"> 
\***NOTE**: if you just do applied research, you will probably never have to think about $e$. However, there is great insight gained into understanding why it's there (refer to appendix)

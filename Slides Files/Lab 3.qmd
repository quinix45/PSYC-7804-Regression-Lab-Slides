...
# save the table to either a word doc or as an image
# You should see the files in the `path` argument appear
# in your working directory
save_as_docx(table, path = "reg_table.docx")
save_as_image(table, path = "reg_table.png")
```
...
<li> `var_names = NULL`: Name the first rows of the table. Must be a character vector of the same length of the table rows. </li>

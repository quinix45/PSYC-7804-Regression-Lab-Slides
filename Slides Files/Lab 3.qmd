...
This is a package where I save functions that I either use a bunch or that I think may be useful in the future. Make sure you run `devtools::install_github("quinix45/FabioFun")` to install it. 
:::
